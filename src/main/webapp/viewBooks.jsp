...
<div class="login-form">
    <div class = "well">
        <form name="myIssueServlet" action="IssueServlet" method="Post">
            ...
            <sql:setDataSource var = "snapshot" driver = "com.mysql.jdbc.Driver" url = "jdbc:mysql://localhost:3306/onlinelms" user = "root"  password = "password"/>
        ...
        <form action="EmailSendingServlet" method="post">
            ...
            <tr>
            	<td colspan="2" align="center"><button type="submit" name="action" value="Send">Confirm Book Issue</button><br></td>
...
function f1(objButton){
    const url = "IssueServlet"; // the script where you handle the form input.
    $.ajax({
        url:'IssueServlet',
